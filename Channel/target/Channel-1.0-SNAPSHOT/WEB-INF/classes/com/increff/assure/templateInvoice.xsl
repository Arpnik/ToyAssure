            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block space-after="5mm"> 
                          <fo:external-graphic src="https://bsmedia.business-standard.com/_media/bs/img/article/2017-07/30/full/1501437790-9307.jpg" content-height="scale-to-fit" height="3cm"  content-width="6cm" scaling="non-uniform" display-align="left"/>
