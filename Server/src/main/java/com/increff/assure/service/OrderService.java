...
public class OrderService {
    ...
    public void allocateOrder(Long orderId) throws ApiException {
        ...
        for (OrderItemPojo item : itemList) {
            ...
            if (allocated && !item.getOrderedQuantity().equals(item.getAllocatedQuantity()))
                allocated = false;
    ...
    @Transactional(rollbackFor = ApiException.class)
    public OrderPojo fulfillOrder(Long orderId) throws ApiException {
        ...
        for (OrderItemPojo item : itemList) {
            ...
            item.setAllocatedQuantity(new Long(0));
