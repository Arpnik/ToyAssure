            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block space-after="5mm"> 
                          <fo:external-graphic src="https://cdn.skillenza.com/files/60f1ed0d-2b2f-4514-9e89-fa84bb23cb80/increff_community_card_banner.png" content-height="scale-to-fit" height="3cm"  content-width="6cm" scaling="non-uniform" display-align="left"/>
